...
from groq import Groq  # Groq's API client
from pydantic import BaseModel

# Set your Groq API Key directly (Replace with your actual API key)
GROQ_API_KEY = "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"
...
def analysis_agent_node(state: ChatState) -> ChatState:
    ...
    for i in range(2):  # Two rounds of 2 questions each
        ...
        generated_questions = response.choices[0].message.content  # ✅ FIXED
    ...
    conclusion = response.choices[0].message.content  # ✅ FIXED
...
def support_agent_node(state: ChatState) -> ChatState:
    ...
    if answer.strip().lower() in ["yes", "y"]:
        ...
        recommendations = response.choices[0].message.content  # ✅ FIXED
